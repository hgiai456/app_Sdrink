...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (productDetail == null) return const Center(child: Text('Không tìm thấy sản phẩm'));
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Padding(
            padding: const EdgeInsets.only(top: 12.0, bottom: 16.0, left: 24.0, right: 24.0),
            child: ClipRRect(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      icon: Icon(
                        Icons.close,
                        color: highlandsTheme.bottomNavigationBarTheme.unselectedItemColor,
                      ),
                      onPressed: () {
              ...
              children: [
                ...
                Text(
                  _selectedSizePrice != null
                      ? NumberFormat('#,### đ').format(_selectedSizePrice)
                      : 'N/A',
                  style: highlandsTheme.textTheme.titleLarge,
                ),
              ],
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Text('Phần trang trí có thể bị ảnh hưởng khi vận chuyển.'),
                  const Text('Giá đã bao gồm 8% VAT.'),
                  const SizedBox(height: 16),
                  const Divider(color: Colors.grey, thickness: 1),
                  const SizedBox(height: 16),
                  Row(
                    children: _sizes.map<Widget>((size) {
                      final isSelected = _selectedSizeName == size['size_name'];
                      return Padding(
                        padding: const EdgeInsets.only(right: 16.0),
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: isSelected ? highlandsTheme.primaryColor : Colors.white,
                  ...
                  Row(
                    children: [
                      ...
                      Text('Ghi Chú', style: highlandsTheme.textTheme.bodyMedium),
                      Text(' (không bắt buộc)', style: highlandsTheme.textTheme.bodySmall?.copyWith(color: Colors.grey)),
                    ],
                  ),
                  ...
                  TextField(
                    decoration: InputDecoration(
                      ...
                      focusedBorder: highlandsTheme.inputDecorationTheme.focusedBorder,
        ...
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: (_selectedSizePrice != null && _sizes.isNotEmpty)
                  ? () {}
                  : null,
              child: Text(
