...
class _ProfileScreenState extends State<ProfileScreen> {
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: const Icon(Icons.camera_alt, size: 16, color: Color(0xFFA10F1A)),
                          ),
                        ),
                      ],
                    ),
                  ...
                  Expanded(
                    child: isEditing
                        ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildEditField(controller: firstNameController, label: 'Tên'),
                              if (firstNameError)
                                const Padding(
                                  padding: EdgeInsets.only(left: 8, bottom: 4),
                                  child: Text('* Vui lòng nhập tên', style: TextStyle(color: Colors.red, fontSize: 13)),
                                ),
                            ],
                          )
                  ...
                  Expanded(
                    child: isEditing
                        ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildEditField(controller: lastNameController, label: 'Họ'),
                              if (lastNameError)
                                const Padding(
                                  padding: EdgeInsets.only(left: 8, bottom: 4),
                                  child: Text('* Vui lòng nhập họ', style: TextStyle(color: Colors.red, fontSize: 13)),
                                ),
                            ],
                          )
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        if (genderError)
                          const Padding(
                            padding: EdgeInsets.only(left: 8, bottom: 4),
                            child: Text('* Vui lòng chọn giới tính', style: TextStyle(color: Colors.red, fontSize: 13)),
                          ),
                      ],
                    )
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        if (dobError)
                          const Padding(
                            padding: EdgeInsets.only(left: 8, bottom: 4),
                            child: Text('* Vui lòng chọn ngày sinh', style: TextStyle(color: Colors.red, fontSize: 13)),
                          ),
                      ],
                    )
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (isEditing && phoneError)
                          const Padding(
                            padding: EdgeInsets.only(left: 8, bottom: 4),
                            child: Text('* Vui lòng nhập số điện thoại', style: TextStyle(color: Colors.red, fontSize: 13)),
                          ),
                      ],
                    ),
                  ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      if (firstNameError || lastNameError || genderError || dobError || phoneError) {
                        return;
                      }
                      setState(() {
  ...
  Widget _buildEditField({required TextEditingController controller, required String label}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
